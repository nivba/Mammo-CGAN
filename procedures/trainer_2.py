...
class Trainer_layer2:
    ...
    def build_generator(self):
        ...
        d0_2 = Conv2D(filters=50, kernel_size=4, strides=1, padding='same')(d0)
        d0_2 = LeakyReLU(alpha=0.2)(d0_2)
        d0_2 = Dropout(0.2)(d0_2)
        # down sampling
        d1 = Conv2D(filters=100, kernel_size=4, strides=2, padding='same')(d0_2)
        d1 = LeakyReLU(alpha=0.2)(d1)
        d1 = Dropout(0.2)(d1)
        d1_2 = Conv2D(filters=100, kernel_size=4, strides=1, padding='same')(d1)
        d1_2 = LeakyReLU(alpha=0.2)(d1_2)
        d1_2 = Dropout(0.2)(d1_2)

        d2 = Conv2D(filters=200, kernel_size=4, strides=2, padding='same')(d1)
        d2 = LeakyReLU(alpha=0.2)(d2)
        d2 = BatchNormalization(momentum=0.8)(d2)
        d2 = Dropout(0.3)(d2)
        d2_2 = Conv2D(filters=200, kernel_size=4, strides=1, padding='same')(d2)
        d2_2 = LeakyReLU(alpha=0.2)(d2_2)
        d2_2 = BatchNormalization(momentum=0.8)(d2_2)
        d2_2 = Dropout(0.3)(d2_2)
        d3 = Conv2D(filters=400, kernel_size=4, strides=2, padding='same')(d2_2)
        d3 = LeakyReLU(alpha=0.2)(d3)
        d3 = BatchNormalization(momentum=0.8)(d3)
        d3 = Dropout(0.35)(d3)
        d3_2 = Conv2D(filters=400, kernel_size=4, strides=1, padding='same')(d3)
        d3_2 = LeakyReLU(alpha=0.2)(d3_2)
        d3_2 = BatchNormalization(momentum=0.8)(d3_2)
        d3_2 = Dropout(0.35)(d3_2)
        d4 = Conv2D(filters=800, kernel_size=4, strides=2, padding='same')(d3_2)
        d4 = LeakyReLU(alpha=0.2)(d4)
        d4 = BatchNormalization(momentum=0.8)(d4)
        d4 = Dropout(0.4)(d4)
        d4_2 = Conv2D(filters=800, kernel_size=4, strides=1, padding='same')(d4)
        d4_2 = LeakyReLU(alpha=0.2)(d4_2)
        d4_2 = BatchNormalization(momentum=0.8)(d4_2)
        d4_2 = Dropout(0.4)(d4_2)
        d5 = Conv2D(filters=1600, kernel_size=4, strides=2, padding='same')(d4_2)
        d5 = LeakyReLU(alpha=0.2)(d5)
        d5 = BatchNormalization(momentum=0.8)(d5)
        d5 = Dropout(0.5)(d5)
        d6 = Conv2D(filters=3200, kernel_size=4, strides=2, padding='same')(d5)
        d6 = LeakyReLU(alpha=0.2)(d6)
        d6 = BatchNormalization(momentum=0.8)(d6)
        d6 = Dropout(0.5)(d6)
        # up sampling
        u6 = deconve(d6, d5, 1600, 0.5)
        u5 = deconve(u6, d4_2, 800, 0.4)
        u4 = deconve(u5, d3_2, 400, 0.35)
        u3 = deconve(u4, d2_2, 200, 0.3)
        u2 = deconve(u3, d1_2, 100, 0.3)
        u1 = UpSampling2D(size=2)(u2)
        u0 = Conv2D(filters=50, kernel_size=1, strides=1, padding='same', activation='relu')(u1)
        u0 = LeakyReLU(alpha=0.2)(u0)
        u0 = BatchNormalization(momentum=0.8)(u0)
        u0 = Dropout(0.2)(u0)
        u0_c = Concatenate()([u0, d0_2])
        # inception module
        incept_1 = Conv2D(filters=25, kernel_size=1, strides=1, padding='same', activation='relu')(u0_c)
        incept_1 = LeakyReLU(alpha=0.2)(incept_1)
        incept_1 = BatchNormalization(momentum=0.8)(incept_1)
        incept_1 = Dropout(0.2)(incept_1)
        incept_3 = Conv2D(filters=25, kernel_size=3, strides=1, padding='same', activation='relu')(u0_c)
        incept_3 = LeakyReLU(alpha=0.2)(incept_3)
        incept_3 = BatchNormalization(momentum=0.8)(incept_3)
        incept_3 = Dropout(0.2)(incept_3)
        incept_5 = Conv2D(filters=25, kernel_size=5, strides=1, padding='same', activation='relu')(u0_c)
        incept_5 = LeakyReLU(alpha=0.2)(incept_5)
        incept_5 = BatchNormalization(momentum=0.8)(incept_5)
        incept_5 = Dropout(0.2)(incept_5)
        incept_pool1 = Conv2D(filters=25, kernel_size=1, strides=1, padding='same', activation='relu')(u0_c)
        incept_pool = MaxPooling2D(pool_size=(2, 2), strides=[1, 1], padding='same')(incept_pool1)
        incept = Concatenate()([incept_1, incept_3, incept_5, incept_pool])
        output_layer = Conv2D(filters=1, kernel_size=1, strides=1, padding='same', activation='relu')(incept)
